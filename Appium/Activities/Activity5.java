...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("9914867536");
        // Press ENTER
        ...
        // Enter text to send
        driver.findElement(AppiumBy.id("compose_message_text")).sendKeys("Hello Appium");
        // Press Send
        driver.findElement(AppiumBy.accessibilityId("Send SMS")).click();

        // Assertion
        String messageTextSent = driver.findElement(AppiumBy.id("message_text")).getText();
        Assert.assertEquals(messageTextSent, "Hello Appium");
    }
