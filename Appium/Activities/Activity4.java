...
public class Activity4 {
    ...
    public void contactsTest() {
        ...
        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text='First name']")).sendKeys("Ravina");

        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text='Last name']")).sendKeys("Solanke");

        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text='Phone']")).sendKeys("999145687");
        // Click Save
        ...
        Assert.assertEquals(contactName, "Ravina Solanke");
    }
